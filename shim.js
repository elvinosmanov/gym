...
function boot(path) {
  ...
  vm.runInContext(`Object.defineProperties(globalThis, {
    ...
    MUSCLES:{get:()=>MUSCLES, configurable:true},
    MMAP:{get:()=>MMAP, configurable:true},
    BODY:{get:()=>BODY, configurable:true},
    WEEKLY_SETS:{get:()=>WEEKLY_SETS, configurable:true},
    musclesOf:{get:()=>musclesOf, configurable:true},
    muscleNames:{get:()=>muscleNames, configurable:true},
    ...
    clockSkewed:{get:()=>clockSkewed, configurable:true},
    clockOffset:{get:()=>clockOffset, configurable:true},
    backAt:{get:()=>backAt, configurable:true},
    fmtD:{get:()=>fmtD, configurable:true},
